...
import { ArrowLeft, Calendar, Car, Clock, Cloud, Globe, MapPin, Navigation, Phone, Plane, Star, Train } from 'lucide-react'
import Link from 'next/link'

const MonumentClient = ({ monument }: { monument: MonumentDetails }) => {
    return (
    <section className="bg-linear-to-b from-orange-50/30 via-white to-gray-50 min-h-screen">
      ...
      <div className="lg:mx-[7%] mx-[4%] font-sans space-y-8 pb-12">
        ...
        <div className="bg-linear-to-b from-orange-500 via-orange-600 to-red-500 rounded-3xl p-8 lg:p-12 text-white shadow-2xl relative overflow-hidden">
                ...
                <div className="space-y-4">
                  {monument.connectivity.road && (
                    <div className="flex items-start gap-3">
                      <Car className="w-6 h-6 text-orange-600 shrink-0 mt-1" />
                      <div>
                  ...
                  {monument.connectivity.rail && (
                    <div className="flex items-start gap-3">
                      <Train className="w-6 h-6 text-orange-600 shrink-0 mt-1" />
                      <div>
                        <p className="font-semibold text-gray-900 mb-1">
                          By Train
                        </p>
                  ...
                  {monument.connectivity.air && (
                    <div className="flex items-start gap-3">
                      <Plane className="w-6 h-6 text-orange-600 shrink-0 mt-1" />
                      <div>
                        <p className="font-semibold text-gray-900 mb-1">
                          By Air
                        </p>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {nearbyMonuments.map((nearby) => (
                ...
                >
                  <div className="relative h-48 bg-linear-to-br from-orange-100 via-amber-100 to-yellow-100">

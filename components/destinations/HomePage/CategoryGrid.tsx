...
import { DestinationCategory } from '@/types/comman';
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        {categories.map((category) => (
          <Link
            ...
            key={category.slug}
            className="group relative bg-linear-to-br from-gray-50 to-gray-100 hover:from-white hover:to-gray-50 rounded-2xl p-6 transition-all hover:scale-105 hover:shadow-xl border border-gray-200"
          >

...
const BookingPolicy: React.FC<BookingPolicyProps> = ({
    ...
    const defaultCancellationPolicies: CancellationPolicy[] = [
        {
            ...
            description: '75% refund of the total booking amount. A processing fee of 5% will be deducted.',
        },
        {
    ...
    const displayCancellationPolicies = cancellationPolicies.length > 0 ? cancellationPolicies : defaultCancellationPolicies;
    const displayTermsAndConditions = termsAndConditions.length > 0 ? termsAndConditions : defaultTermsAndConditions;

    return (
        <div className="space-y-2 mt-10">
            <h2 className="text-2xl font-bold text-gray-900">Booking Policy</h2>

            <div className="bg-linear-to-r from-orange-50 to-orange-100 rounded-lg p-4">
                <div className="flex items-start gap-3">
                    <FiAlertCircle className="w-6 h-6 text-orange-600 mt-0.5 shrink-0" />
                    <div>
                        <h4 className="font-semibold text-orange-900 mb-1">Important Notice</h4>
                        <p className="text-sm text-orange-800">
                            Please read our booking and cancellation policies carefully before confirming your reservation. These terms are designed to protect both parties and ensure a smooth travel experience.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="mt-6 p-4 rounded-lg">
                        <div className="flex items-start gap-2">
                            <p className="text-sm text-blue-800">
                                <strong>Refund Processing:</strong> Approved refunds will be processed within 7-10 business days to the original payment method.
                            </p>
                        </div>
                    </div>
                </div>

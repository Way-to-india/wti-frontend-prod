  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 -mt-20 z-10 relative mb-16">
        <SkeletonItem className="h-[100px] bg-skeleton-card shadow-lg" />
      </div>
      ...
      <div className="bg-skeleton-section py-16 mb-20">
        <div className="container mx-auto px-4">
          <SkeletonItem className="h-8 w-48 mx-auto mb-12" />
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {Array.from({ length: 3 }, (_, index) => (
              <SkeletonItem key={index} className="h-[150px] bg-skeleton-card" />
            ))}
          </div>
        </div>
      </div>
      ...
      <SkeletonItem className="w-full h-[250px] mb-20 bg-skeleton-cta" />
    </div>
  );
};
